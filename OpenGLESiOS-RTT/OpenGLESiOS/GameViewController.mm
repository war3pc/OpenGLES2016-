...
GLint posLocation,colorLocation,textureLocation,normalLocation,MLocation,VLocation,PLocation,NMLocation,fsqPosLocation,fsqTextureLocation;
...
-(void)initScene
{
    ...
    fsqVBO=CreateBufferObject(GL_ARRAY_BUFFER, sizeof(Vertex), &vertex, GL_STATIC_DRAW);
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    ...
    glVertexAttribPointer(fsqPosLocation, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), 0);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
