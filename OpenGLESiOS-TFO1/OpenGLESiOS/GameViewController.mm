...
GLuint vbo,gpuProgram,texture,tfoProgram;
GLint posLocation,colorLocation,textureLocation,texcoordLocation,MLocation,VLocation,PLocation;
...
-(void)initScene
{
    ...
    float datas[]=
    {
        -0.5f,-0.5f,-4.0f,0.0f,0.0f,//position,texcoord
        0.5f,-0.5f,-4.0f,1.0f,0.0f,//position,texcoord
        -0.5f,0.5f,-4.0f,0.0f,1.0f,//position,texcoord
